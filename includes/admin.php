...
<div class="container_4">
	<div id="page-heading" class="clearfix">
    		...
    		<div class="grid_2 align_right">
    				<a href="index.php?do=form" class="button blue medium">Add event</a>
    		</div>
	</div>
</div>
</div>
				...
				<table id="tablesorter-sample" class="tablesorter styled"> 
					...
					<tbody> 
						...
						<tr> 
							...
							<td class="center"><a class="icon-button edit" title="edit event" href="index.php?do=form&edit_event=<?php echo $event->id ?>">Edit</a><a class="icon-button send" title="send details" href="mailto:?subject=<?php echo $event->name; ?> Drivers of Change&amp;body=Link: <?php echo urlencode(BASE_URL.'index.php?event='.$event->id); ?> <?php if($event->password!=''){ echo("Secret Code:".$event->password);} ?>">Send</a></td> 
						</tr>
						<?php unset($event); } ?>
					</tbody> 
					<a class="icon-button send" title="send details" href="#">Send details</a>
				</table>
