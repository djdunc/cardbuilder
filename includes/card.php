    		...
    		<div class="panel">
    			<div class="content no-cap">
    			    ...
    			    <div class="card-options">
    			        ...
    			        <?php if($_SESSION['user_id']){?><a class="icon-button icon-favorite" href="" title="Add to favorites">Add to Favorites</a><span class="counter" id="star-counter">&hellip;</span> <a class="icon-button icon-comment" href="#">Add Comment</a><span class="counter" id="comment-counter"><?php echo count($comments);?></span> <a class="icon-button icon-flag" href="#" title="Report as inappropriate">Report</a><span class="counter" id="flag-counter">&hellip;</span><?php }else{?><p class="icon-button icon-favorite" href="" title="Add to favorites">Favorites</p><span class="counter" id="star-counter">&hellip;</span> <p class="icon-button icon-comment" href="#"> Comments</p><span class="counter" id="comment-counter"><?php echo count($comments);?></span> <p class="icon-button icon-flag" href="#" title="Reported as inappropriate">Reported</p><span class="counter" id="flag-counter">&hellip;</span><?php }?>&nbsp;&nbsp;<a class="icon-button icon-send" href="mailto:?subject=<?php echo $card->question; ?>&amp;body=Drivers of Change: <?php echo $card->name; ?>">Share</a>
    			    </div>
    			</div>
    		</div>
